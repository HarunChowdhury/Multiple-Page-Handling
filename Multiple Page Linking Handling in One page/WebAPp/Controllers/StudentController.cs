...
namespace WebAPp.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            var stdlist = db.Students.Include(a => a.VCourse).Include(c => c.VDepartment);
        ...
        public ActionResult Login(string command)
        {
            if (command == "Cancel")
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,Name,Email,CourseId")] Student student)
        {
            if (ModelState.IsValid)
            {
